...
//             await axios.post(`http://localhost:8080/api/teacher/quizzes/submit`, {
//                 quizId,
...
//                             <h4>{question}</h4>
//                             {quiz.options[index].map((option, oIndex) => (
...
//                                     />
//                                     <label className="form-check-label" htmlFor={`option-${index}-${oIndex}`}>
//                                         {option}
//                                     </label>
//                                 </div>
//                             ))}
