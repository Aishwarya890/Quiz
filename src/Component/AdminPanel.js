...
const AdminPanel = () => {
    ...
    const handleDeleteQuestion = (index) => {
        ...
        const newOptions = options.filter((_, oIndex) => oIndex !== index);
        const newCorrectAnswers = correctAnswers.filter((_, cIndex) => cIndex !== index);
    ...
    // Store the admin's name in localStorage (or set in state)
